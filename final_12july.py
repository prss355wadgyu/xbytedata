...
def get_data(sub_item_link,row):
    ...
    for i in response.xpath('//div[@class="standardcontent"]//div[@class="sidrow"]'):
        ...
        try:
            ...
            try:
                con = db.cursor()
                update_query = f'UPDATE db3.data1 SET status = "completed" WHERE sub_item = "{sub_item}"'
...
if __name__ == '__main__':
    ...
    sql_select_query = 'SELECT * FROM db3.data1 where status="pending"'
